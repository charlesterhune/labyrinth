...
export const useGameStore = defineStore("game", {
    ...
    actions: {
        ...
        playOnline() {
            ...
            API.stateObserver = (apiState) => {
                this.updateFromApi(apiState);
            };
        ...
        updateFromApi(newState) {
            // ==========================================================
            // DEBUG: SHOW EXACTLY WHAT THE MULTIPLAYER SERVER SENT
            // ==========================================================
            console.log("SERVER GAME STATE:", newState);
            console.log("SERVER MAZE:", newState.maze);
            console.log(
                "SERVER ENABLED SHIFT LOCATIONS:",
        ...
        move(moveAction) {
            ...
            const targetCard =
                boardStore.mazeCard(
                    moveAction.targetLocation
                );

            const sourceCard =
                playersStore.mazeCard(
                    moveAction.playerId
                );
            ...
            boardStore.movePlayer(
                boardMove
            );

            const cardChange = {
                playerId: moveAction.playerId,
                mazeCardId: targetCard.id,
            };

            playersStore.changePlayersCard(
                cardChange
            );
            ...
            if (this.isOnline) {
                ...
                if (
                    ...
                    playersStore.objectiveReached(
                        moveAction.playerId
                    );

                    const objectiveMazeCardId =
        ...
        shift(shiftAction) {
            ...
            const pushedOutPlayerIds = [
                ...pushedOutCard.playerIds,
            ];

            const leftoverCard =
                boardStore.leftoverMazeCard;
            ...
            if (this.isOffline) {
                if (
                    ...
                    if (
                        ...
                        /*
                        In offline mode, there are at maximum two players
                        (user and wasm). Hence, it is ok to pick player
                        with index 0 here.
                        */
        ...
        continueTurnProgression(
            ...
            if (
                ...
                this.setTurnProgressionTimeout(
                    0
                );
            }
            ...
            const prepareAction = {
                playerId:
                    nextPlayerAction.playerId,
                action:
                    action.PREPARE_PREFIX +
        ...
        updateNextAction(newAction) {
            ...
            countdownStore.nextActionUpdated(
                newAction
            );
        },
        ...
        setComputationMethods(
            computationMethods
        ) {
            this.serverComputationMethods =
                computationMethods;
        },

        setTurnProgressionTimeout(
            identifier
        ) {
            this.turnProgressionTimeout =
                identifier;
